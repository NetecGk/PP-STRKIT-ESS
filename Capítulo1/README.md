# Práctica 1. Identificar casos de uso de gobernanza en Power Platform
...
## Instrucciones 
Puedes definir el diagrama de acuerdo con tus necesidades, se sugiere el siguiente guion.

### Tarea 1. Contexto (parte superior)
**Paso 1.** Cuadro: “Organización ficticia” (por ejemplo, _Universidad X_, _Empresa de servicios Y_, etc.).
...
Un cuadro verde grande para implementar un CoE:
