# Práctica 2.2. Configurar y validar que los flujos funcionan
...
**Paso 3.** Navega por flujos de nube para identificar cuál activar en algún momento determinado.
...
**Paso 5.** Dispón las configuraciones obligatorios, que generalmente ya vienen por defecto.
...
**Paso 8.** Una vez finalizado el paso anterior, ejecuta los flujos de inventario para que recopilen toda la información dentro del  inquilino, esa recopilación dependerá del tipo de licencia que tengas, permitiendo la activación o no, de los flujos seleccionados.
